...
<html lang="zxx">
<head>
<title>Amaze Dance Academy | Registration Form</title>
		...
		<div class="agileinfo_mail_grids">
			...
			<div class="col-md-11 agileinfo_mail_grid_right">
				<form action="#" method="post">
					...
					<input type="text" name="name" placeholder="Full Name"  required="true" class="form-control">
					<input type="email" name="email" placeholder="Email" required="true" class="form-control">
					</div>
					
					<div class="col-md-6 col-sm-6 wthree_contact_left_grid">
						<input type="text" name="telephone" placeholder="Phone Number" required="true" maxlength="10" pattern="[0-9]+"class="form-control">
...
$cnt=$cnt+1;
					...
					<!-- <div class="col-md-12 col-sm-6" style="margin-top: 1%">
						<h5 style="color: white">Class Type</h5>
								 <p style="text-align: left;"> <input type="radio"  name="gender" id="gender" value="female" checked="true" >Online &nbsp; <input type="radio" name="gender" id="gender" value="Male">Offline</p>
					</div> -->
					<div class="col-md-12 col-sm-6" style="margin-top: 1%">
